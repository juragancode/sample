...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'id_ID': {
          ...
          'Tulis nama lengkapmu': 'Tulis nama lengkapmu',
          'No. HP': 'No. HP',
          'Buat Akun': 'Buat Akun',
          'Yeay! akun berhasil dibuat': 'Yeay! akun berhasil dibuat',
        ...
        'en_US': {
          ...
          'Tulis nama lengkapmu': 'Enter your full name',
          'No. HP': 'Phone Number',
          'Buat Akun': 'Create Account',
          'Yeay! akun berhasil dibuat': 'You’re all set!',
          'Nikmati kemudahan jual beli dengan GAS Indonesia!':
              'Have some great experience with GAS Apps!',
        },
      };
}
