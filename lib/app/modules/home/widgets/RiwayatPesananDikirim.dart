...
class RiwayatPesananDikirim extends StatelessWidget {
  const RiwayatPesananDikirim({
    super.key,
  });
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Column(
            children: [
              for (int index = 0; index < dikirim.length; index++)
                Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              //     222),
                                              child: Text(
                                                "Rp ${f.format(dikirim[index].price.toInt())}",
                                                // "Rp 123.456.789.000",
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                style: TextStyle(
